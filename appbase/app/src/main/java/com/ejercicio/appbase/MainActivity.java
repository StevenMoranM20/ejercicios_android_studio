...
public class MainActivity extends AppCompatActivity {
    ...
    // metoodo para dar de alta los productos
...
// si la variable codigo es diferente a vacio o la variable descripcion  es diferente a vacio o la variable precion es diferente a vacio
    ...
    public void Buscar (View view){
        ...
        if(!codigo.isEmpty()){
            ...
            if (fila.moveToFirst()){
                ...
                Toast.makeText( this, "No exixte ningun articulo ", Toast.LENGTH_SHORT).show();
                BaseDeDatabase.close();
            }
    ...
    public void Eliminar(View view){
        ...
        if (!codigo.isEmpty()){
            ...
            if (cantidad == 1){
                ...
                Toast.makeText( this, "El articulo no exixte ", Toast.LENGTH_SHORT).show();
    ...
    public void Modificar(View view){
        ...
        if (!codigo.isEmpty() && !descripcion.isEmpty() && !precio.isEmpty()){
            ...
            int cantidad = BaseDatabase.update("artuculos", registro, "codigo" +codigo, null );
