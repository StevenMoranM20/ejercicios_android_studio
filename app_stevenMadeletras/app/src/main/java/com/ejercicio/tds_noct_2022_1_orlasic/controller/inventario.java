...
import com.ejercicio.tds_noct_2022_1_orlasic.conexion.AdminSQLiteOpenHelper;
import com.ejercicio.tds_noct_2022_1_orlasic.conexion.AdminSQLiteOpenHelper1;

public class inventario extends AppCompatActivity {
    private EditText et_codigo, et_descripcion, et_precio;
    private Button BtnIrInventario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_codigo = (EditText)findViewById(R.id.txt_correo1);
        et_descripcion = (EditText)findViewById(R.id.txt_nombre1);
        et_precio = (EditText)findViewById(R.id.txt_clave1);
    }
...
// recupar los valores para buscar los Valores
        ...
        if(!codigo.isEmpty()){
            ...
            Toast.makeText(this, "El correo no exixte", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onClick(View view) {
        ...
        BtnIrInventario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(inventario.this, Home.class);
